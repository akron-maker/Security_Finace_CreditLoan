...
public class ConsumerController implements ConsumerAPI {
    ...
    @ApiImplicitParam(name = "callbackURL",
            value = "通知结果回调Url", required = true,
            dataType = "String", paramType = "query")})
    @GetMapping("/my/recharge-records")
    public RestResponse<GatewayRequest> createRechargeRecord(@RequestParam String amount, @RequestParam String callbackUrl){ return null; }
    ...
    public RestResponse<GatewayRequest> createWithdrawRecord(@RequestParam String amount,
