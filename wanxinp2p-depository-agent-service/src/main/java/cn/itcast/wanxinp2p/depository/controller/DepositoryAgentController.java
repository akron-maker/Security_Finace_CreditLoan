...
import cn.itcast.wanxinp2p.api.consumer.model.WithdrawRequest;
...
public class DepositoryAgentController implements DepositoryAgentApi {
    ...
    public RestResponse<GatewayRequest> createRechargeRecord(@RequestBody RechargeRequest rechargeRequest){ return null; }
    ...
    public RestResponse<GatewayRequest> createWithdrawRecord( @RequestBody WithdrawRequest withdrawRequest){ return null; }
